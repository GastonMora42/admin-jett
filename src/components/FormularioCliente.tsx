// src/components/FormularioCliente.tsx - VERSIÓN CORREGIDA Y MEJORADA
'use client'
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-xl border border-white/20 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-hidden shadow-2xl"
        >
          {/* Success Animation */}
          <AnimatePresence>
            {showSuccess && (
